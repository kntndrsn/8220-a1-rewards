...
urlpatterns = [
    ...
    path('employee_reward_list/<int:employee_id>', views.employee_reward_list, name = 'employee_reward_list'),
    path('employee_reward_new/<int:employee_id>', views.employee_reward_new, name = 'employee_reward_new'),
    path('employee_reward/<int:employee_id>/<int:reward_id>/delete/', views.employee_reward_delete, name='employee_reward_delete'),
